...
export const Features: React.FC<FeaturesProps> = ({ currentLang }) => {
  ...
  const featuresList = [
    ...
    {
      id: 'feat-lang',
      icon: <Languages className="w-6 h-6 text-[#075E54] dark:text-[#25D366]" />,
      titleKey: 'feat-lang-title',
      descKey: 'feat-lang-desc',
    },
    {
      id: 'feat1',
      icon: <FileText className="w-6 h-6 text-[#075E54] dark:text-[#25D366]" />,
      titleKey: 'feat1-title',
      descKey: 'feat1-desc',
    },
    {
      id: 'feat2',
      icon: <Mic className="w-6 h-6 text-[#075E54] dark:text-[#25D366]" />,
      titleKey: 'feat2-title',
      descKey: 'feat2-desc',
    },
    {
      id: 'feat-upi',
      icon: <QrCode className="w-6 h-6 text-[#075E54] dark:text-[#25D366]" />,
      titleKey: 'feat-upi-title',
      descKey: 'feat-upi-desc',
    },
    {
      id: 'feat-themes',
      icon: <Palette className="w-6 h-6 text-[#075E54] dark:text-[#25D366]" />,
      titleKey: 'feat-themes-title',
      descKey: 'feat-themes-desc',
    },
    {
      id: 'feat-thermal',
      icon: <Printer className="w-6 h-6 text-[#075E54] dark:text-[#25D366]" />,
      titleKey: 'feat-thermal-title',
      descKey: 'feat-thermal-desc',
    },
    {
      id: 'feat-lowstock',
      icon: <AlertCircle className="w-6 h-6 text-[#075E54] dark:text-[#25D366]" />,
      titleKey: 'feat-lowstock-title',
      descKey: 'feat-lowstock-desc',
    },
    {
      id: 'feat-gstreports',
      icon: <TrendingUp className="w-6 h-6 text-[#075E54] dark:text-[#25D366]" />,
      titleKey: 'feat-gstreports-title',
      descKey: 'feat-gstreports-desc',
    },
    {
      id: 'feat-convert',
      icon: <RefreshCw className="w-6 h-6 text-[#075E54] dark:text-[#25D366]" />,
      titleKey: 'feat-convert-title',
      descKey: 'feat-convert-desc',
    },
    {
      id: 'feat-payments',
      icon: <Coins className="w-6 h-6 text-[#075E54] dark:text-[#25D366]" />,
      titleKey: 'feat-payments-title',
      descKey: 'feat-payments-desc',
    },
    {
      id: 'feat-bizreports',
      icon: <BarChart3 className="w-6 h-6 text-[#075E54] dark:text-[#25D366]" />,
      titleKey: 'feat-bizreports-title',
      descKey: 'feat-bizreports-desc',
    },
    {
      id: 'feat8',
      icon: <BookOpen className="w-6 h-6 text-[#075E54] dark:text-[#25D366]" />,
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="relative">
                  <button 
                    ...
                    className="p-1.5 rounded-full bg-emerald-50 dark:bg-emerald-950/60 text-[#075E54] dark:text-[#25D366] hover:bg-[#25D366] hover:text-white dark:hover:bg-[#25D366] dark:hover:text-[#111B21] transition-colors duration-200 focus:outline-none cursor-pointer"
                  ...
                  {isITCTooltipOpen && (
                    <div className="absolute right-0 bottom-full mb-3 w-64 bg-slate-900 dark:bg-[#202c33] text-white rounded-2xl p-4 shadow-2xl z-40 border border-slate-800 dark:border-emerald-900/30 text-xs leading-relaxed animate-fade-in">
